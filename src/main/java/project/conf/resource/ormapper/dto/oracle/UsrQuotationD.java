...
public class UsrQuotationD extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public UsrQuotationD() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("QUOTATION_D_ID");
		setFrwVarDateColumn("INSERT_DATE,UPDATE_DATE");
		setFrwVarNumberColumn("ROW_INDEX,AMT_PER_UNIT,ITEM_AMT,UNIT");
		setFrwVarClobColumn("");
	...
	public void setQuotationDId(String quotationDId) throws Exception {
		this.quotationDId = quotationDId;
		setValueFromAccessor("QUOTATION_D_ID", quotationDId);
	}
	...
	public void setAmtPerUnit(double amtPerUnit) throws Exception {
		this.amtPerUnit = amtPerUnit;
		setValueFromAccessor("AMT_PER_UNIT", CommonUtil.toString(amtPerUnit));
	}
	...
	public void setItemAmt(double itemAmt) throws Exception {
		this.itemAmt = itemAmt;
		setValueFromAccessor("ITEM_AMT", CommonUtil.toString(itemAmt));
	}
	...
	public String toString() {
		...
		str += "quotationDId : "+quotationDId+"\n";
		str += "rowIndex : "+rowIndex+"\n";
		str += "amtPerUnit : "+amtPerUnit+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"quotationDId\" value=\""+quotationDId+"\">";
		str += "<column name=\"rowIndex\" value=\""+rowIndex+"\">";
		str += "<column name=\"amtPerUnit\" value=\""+amtPerUnit+"\">";
		...
		str += "<column name=\"itemAmt\" value=\""+itemAmt+"\">";
