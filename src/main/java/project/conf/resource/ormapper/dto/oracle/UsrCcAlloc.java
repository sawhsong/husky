...
public class UsrCcAlloc extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private String ccAllocId;
	private String CC_ALLOC_ID;
	private String bankAccntId;
	private String BANK_ACCNT_ID;
	private String ccStatementDId;
	private String CC_STATEMENT_D_ID;
	private String ccStatementId;
	private String CC_STATEMENT_ID;
	...
	public UsrCcAlloc() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("CC_ALLOC_ID");
	 ...
	 * Accessors
	 */
	public String getCcAllocId() {
		return ccAllocId;
	}

	public void setCcAllocId(String ccAllocId) throws Exception {
		this.ccAllocId = ccAllocId;
		setValueFromAccessor("CC_ALLOC_ID", ccAllocId);
	}
	...
	public String getCcStatementDId() {
		return ccStatementDId;
	}

	public void setCcStatementDId(String ccStatementDId) throws Exception {
		this.ccStatementDId = ccStatementDId;
		setValueFromAccessor("CC_STATEMENT_D_ID", ccStatementDId);
	}

	public String getCcStatementId() {
		return ccStatementId;
	}

	public void setCcStatementId(String ccStatementId) throws Exception {
		this.ccStatementId = ccStatementId;
		setValueFromAccessor("CC_STATEMENT_ID", ccStatementId);
	}
	...
	public String toString() {
		...
		str += "ccAllocId : "+ccAllocId+"\n";
		str += "bankAccntId : "+bankAccntId+"\n";
		str += "ccStatementDId : "+ccStatementDId+"\n";
		str += "ccStatementId : "+ccStatementId+"\n";
		str += "procAmt : "+procAmt+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"ccAllocId\" value=\""+ccAllocId+"\">";
		str += "<column name=\"bankAccntId\" value=\""+bankAccntId+"\">";
		str += "<column name=\"ccStatementDId\" value=\""+ccStatementDId+"\">";
		str += "<column name=\"ccStatementId\" value=\""+ccStatementId+"\">";
