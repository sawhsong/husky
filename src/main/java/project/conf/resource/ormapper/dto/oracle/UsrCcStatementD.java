...
public class UsrCcStatementD extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public UsrCcStatementD() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("CC_STATEMENT_D_ID");
		setFrwVarDateColumn("PROC_DATE,INSERT_DATE,UPDATE_DATE");
		setFrwVarNumberColumn("PROC_AMT,ROW_INDEX,CREDIT_AMT,DEBIT_AMT");
		setFrwVarClobColumn("");
