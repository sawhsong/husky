...
public class UsrInvoiceD extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public UsrInvoiceD() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("INVOICE_D_ID");
	...
	public void setInvoiceDId(String invoiceDId) throws Exception {
		this.invoiceDId = invoiceDId;
		setValueFromAccessor("INVOICE_D_ID", invoiceDId);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"invoiceDId\" value=\""+invoiceDId+"\">";
