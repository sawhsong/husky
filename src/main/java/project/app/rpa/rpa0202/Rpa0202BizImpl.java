...
public class Rpa0202BizImpl extends BaseBiz implements Rpa0202Biz {
	@Autowired
	...
	public ParamEntity getList(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			paramEntity.setAjaxResponseDataSet(reportDao.getTrialBalance(qa));
	...
	public ParamEntity doExport(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			srcData = reportDao.getTrialBalance(qa);
			...
			exportHelper.setReportType("TrialBalance");
			exportHelper.setFileType(fileType);
			exportHelper.setFileName("TrialBalance-"+orgId+"_"+CommonUtil.getSysdate(dateFormat));
