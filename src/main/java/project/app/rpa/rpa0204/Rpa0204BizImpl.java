...
public class Rpa0204BizImpl extends BaseBiz implements Rpa0204Biz {
	@Autowired
	...
	public ParamEntity getList(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			paramEntity.setAjaxResponseDataSet(reportDao.getGeneralLedger(qa));
	...
	public ParamEntity doExport(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			srcData = reportDao.getGeneralLedger(qa);
