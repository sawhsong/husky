...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			...
			<td class="tdSearch">
				<ui:text name="fromDate" className="Ct hor" style="width:100px" checkName="Date From" option="date"/>
				<ui:icon id="icnFromDate" className="fa-calendar hor"/>
				<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
				<ui:text name="toDate" className="Ct hor" style="width:100px" checkName="Date To" option="date"/>
...
<div id="divDataArea" class="areaContainer">
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				<th class="thGrid sortable:alphanumeric">Subject</th>
				<th class="thGrid">File</th>
				<th class="thGrid sortable:alphanumeric">Writer Name</th>
				<th class="thGrid sortable:date">Last Update Date</th>
				<th class="thGrid sortable:numeric">Hit Count</th>
			</tr>
		</thead>
