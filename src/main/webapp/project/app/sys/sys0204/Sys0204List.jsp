	...
	<table class="tblSearch">
		...
		<tr>
			...
			<td class="tdSearch">
				...
				<ui:text name="toDate" className="Ct hor" style="width:100px" checkName="sys0204.search.searchDateTo" option="date"/>
				<ui:icon id="icnToDate" className="fa-calendar hor" title="sys0204.search.searchDateTo"/>
			</td>
		</tr>
	</table>
</div>
