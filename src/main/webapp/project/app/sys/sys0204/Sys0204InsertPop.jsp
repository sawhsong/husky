...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:text name="writerName" value="<%=sysUser.getUserName()%>" checkName="sys0204.header.writerName" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="sys0204.header.writerEmail"/></th>
			<td class="tdEdit">
				<ui:text name="writerEmail" value="<%=sysUser.getEmail()%>" checkName="sys0204.header.writerEmail" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="sys0204.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<ui:text name="articleSubject" checkName="sys0204.header.articleSubject" options="mandatory"/>
			</td>
		</tr>
		<tr>
