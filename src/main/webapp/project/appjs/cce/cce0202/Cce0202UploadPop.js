...
$(function() {
	...
	$("#btnDiscard").click(function() {
		...
		commonJs.doProcess({
			url:"/cce/0202/discardCcStatement.do",
	...
	$("#btnSave").click(function() {
		...
		commonJs.doSave({
			url:"/cce/0202/doSave.do",
			showPostMessage:false,
			onSuccess:function(result) {
				var ds = result.dataSet;
				commonJs.confirm({
					contents:"Would you like to go to Credit Card Statement Allocation screen?",
					buttons:[{
						caption:com.caption.yes,
						callback:function() {
							parent.$("#liLeftMenuCCE0204").trigger("click");
						}
					}, {
	...
	loadBankInfo = function() {
		...
		commonJs.doSearch({
			url:"/cce/0202/getBankAccountInfo.do",
			noForm:true,
